...
print(result)
result = round(3.141592)  # 3으로 만듬 반올림해서
print(result)
result = round(3.55555)   # 반올림해서 4로만듬
print(result)

# enumerate() : 반복문이랑 같이 사용됨, 리스트를 쪼개서 순번을 매김(여러개의 튜플로)
...
# 문제1 : pow함수를 직접 만들어보자
def 포우(num1,num2):               # pow, ** 사용금지, 제어문쓰기
    result = 1
    for i in range(num2):
        result = result * num1
    return result
